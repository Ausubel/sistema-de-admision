...
namespace Pruebas
{
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            {
                Console.WriteLine($"({x},{randoms.Next(1, 40)},'{nombre[randoms.Next(nombre.Length)]}','{ap_pat[randoms.Next(ap_pat.Length)]}','{ap_pat[randoms.Next(ap_pat.Length)]}',{edad[randoms.Next(edad.Length)]}),");
            }
            */
